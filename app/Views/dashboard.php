    ...
    <div class="footer py-4">
      <div class="container-fluid text-center">
        <!-- <p>
          ...
          Copyright @<script data-cfasync="false" src="#"></script><script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made  <i class="icon-people-o" aria-hidden="true"></i> by <a href="# target="_blank" >Christian Porang</a>
